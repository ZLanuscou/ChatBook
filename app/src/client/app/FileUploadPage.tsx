import { createFile, useQuery, getAllFilesByUser, getDownloadFileSignedURL, createDocument } from 'wasp/client/operations';
...
export default function FileUploadPage() {
  ...
  const handleUpload = async (e: FormEvent<HTMLFormElement>) => {
    try {
      ...
      const { uploadUrl } = await createDocument({ fileType, title });
      if (!uploadUrl) {
